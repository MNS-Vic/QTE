...
from .event_loop import EventLoop # Relative import
from .events import EventType, MarketEvent, SignalEvent, OrderEvent, FillEvent # Relative import
from qte.data.interfaces import DataProvider
from qte.portfolio.interfaces import Portfolio
...
class BE_Backtester:
    ...
    def __init__(self,
        ...
        参数:
            ...
            broker (ExecutionHandler): 执行处理器实例。
