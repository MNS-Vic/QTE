...
from qte.data.data_source_manager import DataSourceManager
from qte.data.sources.local_csv import LocalCsvSource

class TestGmDataSource(unittest.TestCase):
    """掘金数据源测试"""
    ...
    def setUp(self):
        ...
        """
        self.token = os.environ.get('GM_TOKEN', 'd6e3ba1ba79d0af43300589d35af32bdf9e5800b')
